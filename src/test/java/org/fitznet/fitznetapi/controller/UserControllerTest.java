...
class UserControllerTest {
  ...
  void updateUserShouldUpdateAuthenticatedUserSuccessfully() {
    ...
    UpdateUserRequestDto updateUserRequestDto =
        new UpdateUserRequestDto("mattlol85", "newUsername", "newEmail@example.com", "newPassword123");
  ...
  void updateUserShouldIgnoreBodyUsernameAndTargetAuthenticatedUser() {
    ...
    UpdateUserRequestDto updateUserRequestDto =
        new UpdateUserRequestDto("victimUser", null, "attacker@example.com", "hijackedPassword");
  ...
  void updateUserShouldThrowNotFoundWhenAuthenticatedUserMissingFromDb() {
    ...
    UpdateUserRequestDto updateUserRequestDto =
        new UpdateUserRequestDto(null, null, "new@example.com", null);
